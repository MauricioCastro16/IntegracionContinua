...
const explainErrors = async () => {
	...
	const prompt = `
Genera un mensaje sin el uso de negritas ni itálicas en ningún lado del mensaje, pero con emojis y cuando uses comillas, usá estás: ", que sea breve para Slack sobre el estado de la cobertura de pruebas del proyecto, basándote en la siguiente tabla de cobertura. El mensaje debe ser claro, conciso, y resaltar las áreas clave, incluyendo los archivos que tienen baja cobertura y las áreas que están bien cubiertas. Además, quiero que me vuelvas a mandar la tabla en plain text, bien distribuida con las columnas como para mandarla por slack. Aquí está la tabla de cobertura:
